...
class Ui_PwnDbgGui(object):
    def setupUi(self, PwnDbgGui):
        ...
        self.heap = QTextEdit(self.splitter_4)
        self.heap.setObjectName(u"heap")
        self.splitter_4.addWidget(self.heap)
        ...
        self.watches = QTextEdit(self.splitter)
        self.watches.setObjectName(u"watches")
        self.splitter.addWidget(self.watches)
